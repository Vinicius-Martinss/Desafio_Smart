<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Mensagem de aviso vinda do middleware, se houver: --}}
            @if(session('warning'))
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form id="profile-complete-form" method="POST" action="{{ route('profile.complete.update') }}">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <button type="submit" id="submit-btn"
                                    class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                    ...
                    {{-- Se desejar mostrar mensagem de sucesso pós-AJAX, deixe aqui, mas se for 
                         redirect normal, poderá remover esse bloco --}}
    ...
    {{-- Copie todo o seu bloco de scripts (máscaras, fetch de CEP, validação de CPF etc.) aqui --}}
    @push('scripts')
