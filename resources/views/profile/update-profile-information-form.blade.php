<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        <!-- Profile Photo (mantém do Jetstream) -->
        ...
        <!-- Nome da empresa-->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="nome_empresa" value="Nome da empresa" />
            <x-input id="nome_empresa" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.nome_empresa" />
            <x-input-error for="nome_empresa" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="cpf" type="text" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="telefone" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.telefone" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="cep" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.cep" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="logradouro" type="text" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="complemento" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.complemento" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="bairro" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.bairro" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="cidade" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.cidade" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="estado" type="text" class="mt-1 block w-full"
                     wire:model.defer="state.estado" maxlength="2" />
