<x-app-layout>
  <x-slot name="header">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Plano</h2>
  </x-slot>

  <div class="py-8">
      <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white p-6 shadow rounded-lg">
              {{-- FORMULÁRIO DE EDIÇÃO VIA AJAX --}}
                      ...
                      <div class="col-md-12">
                          <div class="mb-3">
                              ...
                              <textarea class="form-control"
                                        id="descricao"
                                        name="descricao"
                                        rows="3">{{ old('descricao', $plano->descricao) }}</textarea>
                          </div>
                      </div>
                  </div>
              ...
              {{-- SCRIPT PARA TRATAR AJAX + SWEETALERT --}}
              @push('scripts')
